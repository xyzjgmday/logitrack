                            ...
                            <div class="col-lg-12">
                                ...
                                <select name="poli_id" class="form-control" required>
                                    ...
                                    <?php foreach ($poli as $data) {
                                        echo '<option value=' . $data->id . ($data->id == $results->poli_id ? ' selected' : '') . '>' . $data->nama_poli . '</option>';
                                    } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group m-form__group row pt-0">
                            <div class="col-lg-12">
                                ...
                                <input type="text" class="form-control m-input" name="nama_nakes"
                                    ...
                                    placeholder="Masukan Nama Tenaga Medis" value="<?= $results->nama_nakes ?>"
                                    required>
                            </div>
                        </div>
                        <div class="form-group m-form__group row pt-0">
                            <div class="col-lg-6">
                                ...
                                <select name="role" class="form-control" required>
                                    ...
                                    <option value="1" <?= $results->role == 1 ? 'selected' : '' ?>>Dokter Umum</option>
                                    <option value="2" <?= $results->role == 2 ? 'selected' : '' ?>>Dokter Gigi</option>
                                    <option value="3" <?= $results->role == 3 ? 'selected' : '' ?>>Perawat</option>
                                    <option value="4" <?= $results->role == 4 ? 'selected' : '' ?>>Spesialis</option>
                                    <option value="5" <?= $results->role == 5 ? 'selected' : '' ?>>Subspesialis</option>
                                    <option value="6" <?= $results->role == 6 ? 'selected' : '' ?>>Terapis</option>
                                </select>
                            </div>
                            <div class="m-form__group pt-0 pr-3 col-lg-6">
                                ...
                                <input type="number" class="form-control m-input" name="no_telp" data-toggle="m-tooltip"
                                    title="Nomor Telepon" placeholder="Enter your type" value="<?= $results->no_telp ?>"
                                    required>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <select name="prov" class="form-control" id="provinsi">
                                    ...
                                    foreach ($provinsi as $prov) {
                                        echo '<option value="' . $prov->id . '"' . ($prov->id == $results->provinsi_id ? ' selected' : '') . '>' . $prov->nama . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group m-form__group row pt-0">
                            <div class="col-lg-12">
                                ...
                                <input type="number" class="form-control m-input" name="experience"
                                    ...
                                    placeholder="Masukan Lama Pengalaman" value="<?= $results->experience ?>">
                            </div>
                        </div>
                        <div class="form-group m-form__group row pt-0">
                            <div class="col-lg-12">
                                ...
                                <select name="edu" class="form-control">
                                    ...
                                    <?php
                                    foreach ($edu as $edus) {
                                        echo '<option value="' . $edus->id . '"' . ($edus->id == $results->education_id ? ' selected' : '') . '>' . $edus->education_name . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group m-form__group row pt-0">
                            <div class="col-lg-12">
                                ...
                                <input type="text" class="form-control m-input" name="institution"
                                    data-toggle="m-tooltip" title="Lama Pengalaman"
                                    placeholder="Masukan Lama Pengalaman" value="<?= $results->institution ?>">
                            </div>
                        </div>
                        <div class="form-group m-form__group row pt-0">
                            <div class="col-lg-12">
                        ...
                        <div class="form-group m-form__group row pt-0">
                            <div class="col-lg-12">
                                ...
                                <textarea type="text" class="form-control m-input" name="note" data-toggle="m-tooltip"
                                    title="Catatan"> <?= $results->note; ?> </textarea>
                            </div>
                        </div>
                    </div>
                </div>
