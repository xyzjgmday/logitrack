            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="product_code"
                            value="<?= $hasil->product_code; ?>" placeholder="Enter your type" data-toggle="m-tooltip"
                            title="Nama Barang" required>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                ...
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12 font-weight-bold">Stock <span
                            class="m--font-danger">*</span></label>
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="quantity"
                            value="<?= $hasil->quantity; ?>" placeholder="Enter your type" data-toggle="m-tooltip"
                            title="Nama Barang" required>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="price" id="price"
                            value="<?= $hasil->price; ?>" placeholder="Enter your type" data-toggle="m-tooltip"
