            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="nama_drivers"
                            value="<?= $hasil->name; ?>" placeholder="Enter your type" data-toggle="m-tooltip"
                            title="Nama Drivers" required>
                    </div>
                </div>
                ...
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12 font-weight-bold">Plat Nomor <span
                            class="m--font-danger">*</span></label>
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="plat_no"
                            value="<?= $hasil->plat_nomor; ?>" placeholder="Enter your type" data-toggle="m-tooltip"
                            title="Plat Nomor" required>
                    </div>
                </div>
            </div>
