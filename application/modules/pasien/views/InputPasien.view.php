        ...
        <form class="m-form m-form--fit m-form--label-align-right" id="insert" action="<?= $url; ?>" method="post">
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row">
                    <label class="col-lg-3 col-form-label" for="nik">No NIK:</label>
                    <div class="col-lg-3">
                        <input type="number" class="form-control m-input" name="nik" id="nik" data-toggle="m-tooltip" title="NIK" placeholder="Enter your type" required>
                    </div>
                    <label class="col-lg-2 col-form-label" for="bpjs">No BPJS: <small>(Jika Ada)</small></label>
                    <div class="col-lg-3">
                        <input type="number" class="form-control m-input" name="bpjs" id="bpjs" data-toggle="m-tooltip" title="BPJS" placeholder="Enter your type">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-form-label col-lg-3 col-sm-12">Nama Pasien *</label>
                    <div class="col-lg-8 col-md-9 col-sm-12">
                        <input type="text" class="form-control m-input" name="name" placeholder="Enter your type" data-toggle="m-tooltip" title="Nama Pasien" required>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label class="col-lg-3 col-form-label">Tempat Lahir:</label>
                    <div class="col-lg-3">
                        <input type="text" class="form-control m-input" name="tmp_lahir" data-toggle="m-tooltip" title="Tempat Lahir Pasien" placeholder="Enter your type" required>
                    </div>
                    <label class="col-lg-2 col-form-label">Tanggal Lahir:</label>
                    <div class="col-lg-3">
                        <input type="date" class="form-control m-input" name="tgl_lahir" data-toggle="m-tooltip" title="Tanggal Lahir Pasien" placeholder="Enter your type" required>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-3">
                        <div class="m-radio-inline">
                            <label class="m-radio m-radio--solid">
                                <input type="radio" name="jenis_kelamin" checked value="1"> Laki-Laki
                                <span></span>
                            </label>
                            <label class="m-radio m-radio--solid">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-8 col-md-9 col-sm-12">
                        <textarea type="text" class="form-control m-input" name="alamat" data-toggle="m-tooltip" title="Alamat" required> </textarea>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <select name="agama" class="form-control" required>
                            ...
                            foreach ($agama as $agm) {
                                echo '<option value="' . $agm->id . '">' . $agm->religion_name . '</option>';
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="m-typeahead">
                            <input class="form-control m-input" type="text" id="job" name="job">
                        </div>
                    </div>
                </div>
            </div>
