...
if (!function_exists('tglIndoF')) {
    function tglIndoF($tanggal)
    {
        $ubahTanggal = gmdate($tanggal, time() + 60 * 60 * 8);
        $pecahTanggal = explode('-', $ubahTanggal);
        $tanggal = $pecahTanggal[2];
...
if (!function_exists('tglIndoM')) {
    function tglIndoM($tanggal)
    {
        $ubahTanggal = gmdate($tanggal, time() + 60 * 60 * 8);
        $pecahTanggal = explode('-', $ubahTanggal);
        $tanggal = $pecahTanggal[2];
...
if (!function_exists('tglIndoP')) {
    function tglIndoP($tanggal)
    {
        $ubahTanggal = gmdate($tanggal, time() + 60 * 60 * 8);
        $pecahTanggal = explode('-', $ubahTanggal);
        $tanggal = $pecahTanggal[2];
...
if (!function_exists('tglIndoMY')) {
    function tglIndoMY($tanggal)
    {
        $ubahTanggal = gmdate($tanggal, time() + 60 * 60 * 8);
        $pecahTanggal = explode('-', $ubahTanggal);
        $bulan = bulan_pendek($pecahTanggal[1]);
